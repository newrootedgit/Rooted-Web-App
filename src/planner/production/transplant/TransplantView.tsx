...
export function TransplantView() {
  ...
  const { tasks, isLoading } = useTransplantTasks({
  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        <div className="text-sm text-muted-foreground">Loading transplant tasks...</div>
      ) : (
        <TransplantSchedule groupedTasks={groupedTasks} onAssignRack={setSelectedTask} />
      )}
